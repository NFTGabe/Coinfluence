...
/*
    #CFLU features:
        ...
        2% fee auto send to admin wallet to support marketing and growth
*/
...
contract CFLUToken is Context, IERC20, Ownable {
    ...
    function _takeMarketing(uint256 tMarketing) private {
        uint256 currentRate =  _getRate();
        uint256 rMarketing = tMarketing.mul(currentRate);
        _rOwned[maketingWallet] = _rOwned[maketingWallet].add(rMarketing);
    ...
    function burn(uint256 amount) public {
        address sender = _msgSender();
        require(balanceOf(sender) >= amount, "Amount must be less than balance");
        uint256 currentRate =  _getRate();
    ...
    function getCurrentLiquidityBalance() public view returns (uint256 amount) {
